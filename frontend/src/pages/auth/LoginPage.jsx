...
export default function LoginPage() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #0a0a0a 0%, #111 50%, #0f0a00 100%)",
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: "#eab308" }}>
            EVOLUTION GYM MANAGEMENT
          </p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-gold w-full mt-2 py-3 text-sm"
          >
            {loading ? "Đang đăng nhập..." : "Đăng nhập"}
          </button>
          <button
            onClick={() => navigate("/")}
            className="cursor-pointer bg-white w-full mt-2 py-3 text-sm text-black font-bold rounded-sm"
          >
            Quay về trang chủ
          </button>
        </form>
        ...
        >
          ...
          <div className="text-gray-400">
            Admin: <span className="text-yellow-400">admin@fitcore.vn</span>
          </div>
          <div className="text-gray-400">
            Staff: <span className="text-yellow-400">staff@fitcore.vn</span>
          </div>
          <div className="text-gray-400">
            Member: <span className="text-yellow-400">mai@gmail.com</span>
          </div>
          <div className="text-gray-400">
            Mật khẩu: <span className="text-yellow-400">password</span>
          </div>
        </div>
      </div>
    </div>
