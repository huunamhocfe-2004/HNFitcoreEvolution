  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 text-slate-900">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl items-center px-4 py-10 sm:px-6 lg:px-10">
        <div
          className={`grid w-full items-stretch overflow-hidden rounded-4xl border border-slate-200 bg-white shadow-2xl shadow-slate-200/80 backdrop-blur-sm transition-all duration-500 lg:grid-cols-[1.05fr_0.95fr] ${
            show
        ...
        >
          {/* Left content */}
          <div className="relative hidden overflow-hidden bg-white p-10 lg:flex lg:flex-col lg:justify-between">
            ...
            >
              <button
                type="button"
                onClick={() => navigate("/")}
                className="mb-10 inline-flex cursor-pointer items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 shadow-sm transition hover:bg-red-50 hover:text-red-600"
              >
                <ChevronLeft size={16} />
                Quay về trang chủ
              </button>
              ...
              <div className="mt-10 grid gap-4 sm:grid-cols-3">
                {[
                  ...
                  <div
                    key={item.label}
                    className={`rounded-2xl border border-slate-200 bg-slate-50 p-4 transition-all duration-700 hover:-translate-y-1 hover:bg-white/10 ${
                      show
            ...
            <div
              className={`relative z-10 mt-10 rounded-3xl border border-slate-200 bg-slate-50 p-6 transition-all duration-500 delay-500 ${
          ...
          {/* Right form */}
          <div className="bg-white p-6 sm:p-8 lg:p-10 flex col justify-center items-center">
            <div
            ...
            >
              <div className="mb-8 lg:hidden">
                <button
                  type="button"
                  onClick={() => navigate("/")}
                  className="inline-flex cursor-pointer items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 shadow-sm transition hover:bg-red-50 hover:text-red-600"
                >
                  <ChevronLeft size={16} />
                  Quay về trang chủ
                </button>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={form.email}
                      onChange={handle}
                      className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-12 pr-4 text-slate-900 transition-all placeholder:text-slate-400 focus:border-red-500 focus:bg-white/10 focus:outline-none focus:ring-1 focus:ring-red-500"
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      value={form.password}
                      onChange={handle}
                      className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-12 pr-12 text-slate-900 transition-all placeholder:text-slate-400 focus:border-red-500 focus:bg-white/10 focus:outline-none focus:ring-1 focus:ring-red-500"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPw((p) => !p)}
                      className="absolute right-4 top-1/2 -translate-y-1/2 cursor-pointer text-slate-500 transition hover:text-red-600"
                    >
