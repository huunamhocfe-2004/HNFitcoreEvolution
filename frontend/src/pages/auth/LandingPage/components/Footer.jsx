...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200 bg-white px-6 py-12 pb-0 text-slate-900 lg:px-10">
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-2 lg:grid-cols-5">
        ...
        <div>
          ...
          <div className="mt-4 flex overflow-hidden rounded-full bg-white/10 border border-slate-300">
            <input
              type="text"
              placeholder="Enter your email"
              className="w-full bg-transparent px-4 py-3 text-sm outline-none placeholder:text-slate-400"
            />
            <button className="bg-red-600 px-4 text-white font-semibold cursor-pointer">→</button>
          </div>
        </div>
      </div>

      <p className="my-6 flex items-center justify-center gap-2 py-2 text-center text-sm font-bold text-slate-700">
