  ...
  return (
    <header className="mx-auto flex max-w-7xl items-center justify-between py-6">
      <div className="flex gap-5">
        <div className="relative h-15 w-15 overflow-hidden rounded-full border border-black">
          <img
      ...
      <nav className="hidden items-center gap-4 text-sm text-slate-700 md:flex">
        ...
        <a
          href="#about"
          className="px-4 py-2 rounded-full transition-colors duration-300 hover:text-red-600 hover:bg-red-50"
        >
          About us
        </a>
        <a
      ...
      <button
        ...
        className="cursor-pointer rounded-xl bg-red-600 px-5 py-2.5 text-white text-sm font-semibold shadow-lg shadow-red-900/40 transition hover:bg-red-500"
      >
        Đăng nhập
      </button>
    </header>
